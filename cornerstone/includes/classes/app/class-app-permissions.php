...
class Cornerstone_App_Permissions extends Cornerstone_Plugin_Component {
  ...
  public function hide_deprecated_elements( $defaults ) {
    ...
    $definitions = CS()->novus()->service('Elements')->manager()->get_all_elements();
  ...
  public function user_can_access_post_type( $post = '') {
    ...
    $allowed = $this->get_user_post_types();
  ...
  public function get_general_controls() {
    ...
    $hf_options = array( 'create', 'create_from_template', 'rename', 'delete', 'save_as_template', 'manage_assignments', 'elements_create', 'elements_delete', 'elements_move', 'elements_inspect', 'apply_presets', 'save_presets', 'edit_custom_css', 'edit_custom_js' );
    $content_options = array( 'publish', 'manage_layout', 'insert_templates', 'save_templates', 'elements_create', 'elements_delete', 'elements_move', 'elements_inspect', 'apply_presets', 'save_presets', 'edit_custom_css', 'edit_custom_js', 'settings', 'skeleton_mode' );
    $manager_options = array( 'create', 'change', 'rename', 'delete');

    $types = $this->get_content_types();

    $items = array(
      'headers' => csi18n('common.title.header-builder'),
    ...
    $items = array_merge($items, array(
      'footers' => csi18n('common.title.footer-builder'),
  ...
  public function get_element_controls() {
    ...
    $elements = CS()->novus()->service('Elements')->manager()->get_public_definitions();
  ...
  public function get_macros() {
    ...
    foreach ( $text_only_contexts as $context ) {
      ...
      $context_keys = $this->get_context_keys($context);
