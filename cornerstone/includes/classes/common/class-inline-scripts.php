...
class Cornerstone_Inline_Scripts extends Cornerstone_Plugin_Component {
  ...
  public function setup() {
    add_action('wp_footer', [$this, 'global_custom_js'], 0);
    add_action('wp_footer', [$this, 'output_scripts'], 9998);
  }

  public function global_custom_js() {
    $this->add_script('cornerstone-custom-js', get_option( apply_filters('cs_global_js_option', 'cs_v1_custom_js' ), '' ) );
  }
