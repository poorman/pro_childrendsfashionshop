...
function penci_default_setting_customizer( $name ) {
	$defaults = array(
		...
		'cimage'                      => __( 'Choose Image', 'soledad' ),
		'admedia'                     => __( 'Add Media', 'soledad' ),
		'insert'                      => __( 'Insert', 'soledad' ),
		'oldpassword'                 => __( 'Old Password', 'soledad' ),
		'newpassword'                 => __( 'New Password', 'soledad' ),
		'cpassword'                   => __( 'Confirm Password', 'soledad' ),
		'changepassword'              => __( 'Change Password', 'soledad' ),
		...
		'like_posts'                    => __( 'Like Posts', 'soledad' ),
		...
		'showing_result' => __( 'Showing {{value}}-{{value}} of {{value}} post results', 'soledad' ),
		'sort_latest'    => __( 'Sort by latest', 'soledad' ),
		'sort_older'     => __( 'Sort by older', 'soledad' ),
		'no_content'     => __( 'No Content Available', 'soledad' ),
	);
